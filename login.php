...
if(isset($_COOKIE['id']) && isset($_COOKIE['key'])) {
  ...
  $result = mysqli_query($conn, "SELECT username FROM akun_user WHERE id = $id ");
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5">
          <div class="card bg-secondary shadow border-0">
           <p class="display-3 text-primary mx-auto pt-3">Login Form</p> 
        ...
        <div class="row mt-2">
          <div class="mx-auto">
            ...
            <?php
              if ( isset($error) ) : ?>
                <p style="font-style: italic; color: red; text-align: center;">Wrong password / username</p>
              <?php endif; ?>
          </div> 
        </div>
